...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier forCalatorie:(BOOL)k withReducere:(BOOL)red
{
    ...
    if (self) {
        ...
        lblPrima = [[UILabel alloc] initWithFrame:CGRectMake(108, 38, 140, 42)];
        lblPrima.textColor = [YTOUtils colorFromHexString:ColorTitlu];
        lblPrima.font = [UIFont fontWithName:@"Arial Rounded MT Bold" size:18];
        
        lblPrimaTaiat = [[UILabel alloc] initWithFrame:CGRectMake(110, 23, 80, 21)];
        lblPrimaTaiat.textColor = [YTOUtils colorFromHexString:ColorTitlu];
        lblPrimaTaiat.font = [UIFont fontWithName:@"Arial Rounded MT Bold" size:17];
        
        lblStrike = [[UILabel alloc] initWithFrame:CGRectMake(105, 33, 90, 1)];
        lblStrike.textColor = [YTOUtils colorFromHexString:@"#FF1900"];
        lblStrike.backgroundColor =[YTOUtils colorFromHexString:@"#FF1900"];
        lblStrike.font = [UIFont fontWithName:@"Arial Rounded MT Bold" size:1];
        
        lblCol1 = [[UILabel alloc] initWithFrame:CGRectMake(7, 74, 57, 21)];
        ...
        if (red)
        {
            [self.contentView addSubview:lblPrimaTaiat];
...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier forLocuinta:(BOOL)k
{
    ...
    if (self) {
        ...
        lblRaspCivila = [[UILabel alloc] initWithFrame:CGRectMake(257, 97, 70, 12)];
        ...
        [self.contentView addSubview:lblCol4];
        [self.contentView addSubview:imgSport];
        [self.contentView addSubview:lblRaspCivila];
        [self.contentView addSubview:lblDunga];
        [self.contentView addSubview:lblDunga2];
        [self.contentView addSubview:btnComanda];
        [self.contentView addSubview:lblAlegePrima];
...
- (void) setPrimaTaiat:(NSString *)p
{
    lblPrimaTaiat.text = p;
}
